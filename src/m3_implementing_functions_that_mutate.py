...
def swap_colors(circle, rectangle):
    ...
    color_circle_should_have = rectangle.fill_color
    color_rectangle_should_have = circle.fill_color
    circle.fill_color = color_circle_should_have
    rectangle.fill_color = color_rectangle_should_have
